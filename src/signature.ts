...
export const CHANGEOWNER_TYPEHASH = keccak256(
  //toUtf8Bytes('Permit(address owner,address spender,uint256 value,uint256 nonce,uint256 deadline)')
  toUtf8Bytes('changeOwnerSigned(address identity, uint8 sigV, bytes32 sigR, bytes32 sigS, address newOwner)')
)
      ...
      [
        ...
        keccak256(
          defaultAbiCoder.encode(
            ...
            [CHANGEOWNER_TYPEHASH, approve.owner, approve.spender, approve.value, nonce, deadline]
          )
        ),
      ]
    )
